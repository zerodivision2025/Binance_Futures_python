...
class RequestClient(object):
    ...
    def get_old_trade_lookup(self, symbol: str, limit: int = None, fromId: int = None) -> any:
        """
    ...
    def get_aggregate_trades_list(self, symbol: str, fromId: int = None, 
    ...
    def get_funding_rate(self, symbol: str, startTime: int = None, endTime: str = None, limit: int = None) -> any:
        """
    ...
    def get_liquidation_orders(self, symbol: str = None, startTime: int = None, endTime: str = None, 
                                limit: int = None) -> any:
        """
    ...
    def change_position_mode(self, dualSidePosition: bool = None) -> any:
        """
    ...
    def post_order(self, symbol: str, side: OrderSide, ordertype: OrderType, 
                ...
                reduceOnly: bool = None, price: float = None,
                newClientOrderId: str = None, stopPrice: float = None, 
                workingType: WorkingType = WorkingType.INVALID, closePosition: bool = None,
    ...
    def get_order(self, symbol: str, orderId: int = None, origClientOrderId: str = None) -> any:
        """
    ...
    def cancel_order(self, symbol: str, orderId: int = None, origClientOrderId: str = None) -> any:
        """
        Cancel Order (TRADE)
    ...
    def get_all_orders(self, symbol: str = None, orderId: int = None, startTime: int = None, 
    ...
    def get_account_trades(self, symbol: str = None, startTime: int = None, endTime: int = None, 
                        fromId: int = None, limit: int = None) -> any:
        """
    ...
    def auto_cancel_all_orders(self, symbol: str, countdownTime: int) -> any:
        """
